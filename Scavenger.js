...
function saveProgress() {
    localStorage.setItem('scavengerHuntProgress', currentClueIndex);
}

function loadProgress() {
    const savedIndex = localStorage.getItem('scavengerHuntProgress');
    if (savedIndex !== null) {
...
function startGame() {
    ...
    fadeOut(container, () => {// Reset to the first clue
        loadProgress();
        showNextClue();
    });
}
